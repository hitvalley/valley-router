var ValleyRouter = (function (ValleyModule) {
'use strict';

ValleyModule = ValleyModule && ValleyModule.hasOwnProperty('default') ? ValleyModule['default'] : ValleyModule;
...
var browser_1 = browser.debug;
var browser_2 = browser.log;
var browser_3 = browser.formatArgs;
var browser_4 = browser.save;
var browser_5 = browser.load;
var browser_6 = browser.useColors;
var browser_7 = browser.storage;
var browser_8 = browser.colors;

// const ValleyModule = require('valley-module');
// const pathToRegexp = require('path-to-regexp');
// const debug = require('debug')('valley-rooter');
const debug = browser('valley-rooter');
const METHODS = [
  'HEAD',
  'OPTIONS',
  'GET',
...
class RouterModule extends ValleyModule {
  ...
  setPrefix(prefix) {
    ...
    this.routers = this.routers.map(item => {
      ...
      let keys = [];
      item.rule = pathToRegexp_1(wholePath, keys, { end: item.end });
      return item;
    });
  }
  add(path, methods, router) {
    ...
    let rule = pathToRegexp_1(wholePath, keys, { end });
